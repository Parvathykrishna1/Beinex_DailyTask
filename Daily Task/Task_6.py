...
# multiply_with_unknown = lambda x : x * unknown_num

# n = int(input("Enter a number: "))
# unknown_num = 4
# result = multiply_with_unknown(n)
...
# max_val = max(lst, key = lambda x: (type(x) != str, x))

# print("Original list:", lst)
# print("Maximum value in the list using lambda:", max_val)
