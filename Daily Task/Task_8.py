...
# 	Expected Result : 3
# list_data = ['wx', 'pythonz', '12', 'i','jkl9']
...
#     else:
#         list2.append(i)  
# print("Final list after removing even numbers:",list1)          
...
# 7. Write a Python program to find the repeated items of a tuple.
# tup = (3, 5, 6, 7, 8, 2, 7, 4, 7)
# repeated_items = {x for x in tup if tup.count(x) > 1}
# print("Repeated items in the given tuple:",repeated_items)
